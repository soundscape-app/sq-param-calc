...
def calc_sharpness(loudness, specificLoudness):
    ...
    suma = 0
    for i, z in enumerate(float_range(0.1, 1 / 10 + 0.1, 0.1)):
    ...
    suma = 0
    for i, z in enumerate(float_range(0.1, n/10 + 0.1, 0.1)):
    ...
    return round(sharpnessZwicker, 2), round(sharpnessVonBismarck), round(sharpnessAures, 2)